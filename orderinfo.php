...
<?php 
                                ...
                                $sql = "SELECT OrderID, Username, Totalprice, orderdate, reference, Firstname, Lastname, Street, City, Province, MobileNo, Email 
...
<body>
        ...
        <div class="container">
            <div class="account-inner">
                <div class="account-side-navigation">
                 ...
                 <a href="adminorderspage.php"class="filter-btn" data-show=".accountdtls"><i class="fal fa-user"></i>Return</a>

                  <!--================= Status =================-->
                  <h2>Order Status</h2>
                    <form action="approve.php" method="POST">
                        <input type="hidden" name="approve"value="Confirmed">
                        <button type="submit"class="filter-btn" data-show=".accountdtls">Confirm</button>
                    </form>
                    <br>
                    <form action="packing.php" method="POST">
                    <input type="hidden" name="packing"value="packing">
                        <button type="submit"class="filter-btn" data-show=".accountdtls">Packing</button>
                    </form>
                    <br>
                    <form action="delivering.php" method="POST">
                    <input type="hidden" name="delivering"value="delivering">
                        <button type="submit"class="filter-btn" data-show=".accountdtls">Delivering</button>
                    </form>
                    <br>
                    ...
                    <input type="hidden" name="delivered"value="delivered">
                        <button type="submit"class="filter-btn" data-show=".accountdtls">Delivered</button>
                    </form>
                    <br>

                    <form action="removeorder.php" method="POST">
                    <input type="hidden" name="remove"value="remove order">
                        <button type="submit"class="filter-btn" data-show=".accountdtls">Remove Order</button>
                    </form>
                    <br>
                    <!--================= Logout na button =================-->
    ...
    foreach($result as $value):?>
                                <h1>Order info</h1>
                                <h1>Username: </h1><h3><?php echo $value['Username']?></h3>
                                </div>
                        </div>
                        <p>From your account dashboard you can view your orders details, manage your shipping and billing
                            addresses.</p>

                        <h3>Note: After clicking the delivered button this order will now only show to the
                    "Orders delivered" tab under the "sales" page.</h3>
...
?>
                        ...
                        $orderid = $_SESSION['orderid'];
                                ...
                                $sql = "SELECT `OrderID`, `username`, `prod`, `quantity`, `price`, `combinedprice`, `orderdate` FROM `ordereditems` WHERE OrderID = '$orderid'";
                                $result = $conn->query($sql); ?>
 <table class="table">
                            <thead>
                                <tr class="top-tr">
...
<?php
    foreach($result as $value):?>
                                    ...
                                    <td><?php echo $value['combinedprice']?></td>
                                    <?php endforeach;
?>
                                    </tr>
                            </tbody>
