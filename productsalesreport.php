        ...
        <div class="container">
            <div class="account-inner">
                <div class="account-side-navigation">
                 ...
                 <a href="salespage.php"class="filter-btn" data-show=".accountdtls"><i class="fal fa-user"></i>Return</a>
                    ...
                    <div class="account-main dashboard filterd-items">
                        <div class="account-profile-area">
                            <div class="d-block">
                                ...
                                <h1>SIRA PA TO PRODUCT SALES (PENDING`)</h1>
                            </div>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <?php 
                                    $sql = "SELECT distinct `basesalesdate`
                                    FROM orders where status = 'delivered' ";
                                    $result = $conn->query($sql); ?>
                                    <?php foreach($result as $value):?>
                                    <tr>        
                                    <td><?php echo $value['basesalesdate']?></td>
                                    
                                    
                                    <?php $sql = "SELECT prodname FROM products";
                                    $result = $conn->query($sql);
                                    foreach($result as $value):
                                    $_SESSION['prodname'] = $value['prodname'];
                                    $product = $_SESSION['prodname'];
                                endforeach; ?> 

                                    <?php
                                    $sql = "SELECT `OrderID`, `username`, `prod`, `quantity`, `price`, `combinedprice`, `orderdate` FROM `ordereditems` WHERE 1";
                                    $result = $conn->query($sql);
                                    foreach($result as $value):
                                    ?>
                ...
                <div class="navbar-part navbar-part1">
                    <div class="navbar-inner">
                        <div class="left-side">
                            ...
                            <img src="assets/images/logoroicher.png" alt="umart-logo">
                        </div>
