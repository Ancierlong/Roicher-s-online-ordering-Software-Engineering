...
<?php 
                                ...
                                $sql = "SELECT OrderID, Totalprice, orderdate, reference, Firstname, Lastname, Street, City, Province, MobileNo, Email 
        ...
        <div class="container">
            <div class="account-inner">
                <div class="account-side-navigation">
                 ...
                 <a href="ordersdelivered.php"class="filter-btn" data-show=".accountdtls"><i class="fal fa-user"></i>Return</a>

                  <!--================= Status =================-->

                    <form action="removedelivereditem.php" method="POST">
...
?>
                        ...
                        $orderid = $_SESSION['orderid'];
                                ...
                                $sql = "SELECT prod, quantity, price, combinedprice , orderdate
                                FROM ordereditems where OrderID = '$orderid'";
                                $result = $conn->query($sql); ?>
 <table class="table">
                            <thead>
                                <tr class="top-tr">
