...
<?php 
                                ...
                                $sql = "SELECT `id`, `username`, `email`, `password` FROM `accounts` WHERE `id` = '$id'";
        ...
        <div class="container">
            <div class="account-inner">
                <div class="account-side-navigation">
                 ...
                 <a href="useraccounts.php"class="filter-btn" data-show=".accountdtls"><i class="fal fa-user"></i>Return</a>
...
?>
                        ...
                        <?php 
                                ...
                                $sql = "SELECT `fn`, `ln`, `address` FROM `accounts` where id = '$id' ";
                                $result = $conn->query($sql); ?>
 <table class="table">
                            <thead>
                                <tr class="top-tr">
