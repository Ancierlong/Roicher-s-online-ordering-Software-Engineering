...
<?php 
                                ...
                                $sql = "SELECT `reqid`, `username`, `reqtype`, `reqfullname`, `reqemail`, `reqno`, `reqmess`, `reqdate` FROM `requests` WHERE `reqid` = '$reqid'";
                ...
                <div class="account-side-navigation">
                 ...
                 <a href="adminpage.php"class="filter-btn" data-show=".accountdtls"><i class="fal fa-user"></i>Return</a>
                  ...
                  <!--================= Status =================-->
                    ...
                    <form action="removerequest.php" method="POST">
                    <input type="hidden" name="remove"value="remove order">
                        <button type="submit"class="filter-btn" data-show=".accountdtls">Remove Request</button>
                    </form>
                    <br>
                    ...
                    <div class="account-main dashboard filterd-items">
                        <div class="account-profile-area">
                            ...
                            <div class="d-block">
                                ...
                                <span class="profile-date d-block">June 23, 2022</span>
                            </div>
                        </div>
...
<?php
    foreach($result as $value):?>
                                    <tr>
                                    <td><?php echo $value['reqid']?></td>
                                    <input type="hidden" name="reqid" value="<?php echo $value['reqid']?>">
                                        <td><?php echo $value['reqtype']?></td>
                                        <td><?php echo $value['username']?></td>
                                        <td><?php echo $value['reqdate']?></td>
                                        <td><?php echo $value['reqfullname']?></td>
                                        <td><?php echo $value['reqemail']?></td>
